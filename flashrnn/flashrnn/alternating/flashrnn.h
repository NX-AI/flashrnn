...
public:
  ...
  int Iterate(const cudaStream_t &stream, const FLASHRNN_DTYPE_R *R,
...
private:
  int IterateInternal(const FLASHRNN_DTYPE_W *x, const FLASHRNN_DTYPE_R *R,
...
public:
  ...
  // corresponding
  //     iteration.
  int Iterate(const cudaStream_t &stream, const FLASHRNN_DTYPE_R *R_t,
              const FLASHRNN_DTYPE_B *b, const FLASHRNN_DTYPE_S *s,
...
private:
  int IterateInternal(const FLASHRNN_DTYPE_R *R_t, const FLASHRNN_DTYPE_B *b,
